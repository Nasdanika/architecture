 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.architecture.cloud.azure.compute.VirtualMachine#getDisks <em>Disks</em>}</li>
 *   <li>{@link org.nasdanika.architecture.cloud.azure.compute.VirtualMachine#getNetworkInterfaces <em>Network Interfaces</em>}</li>
 *   <li>{@link org.nasdanika.architecture.cloud.azure.compute.VirtualMachine#getImage <em>Image</em>}</li>
 *   <li>{@link org.nasdanika.architecture.cloud.azure.compute.VirtualMachine#getSize <em>Size</em>}</li>
 * </ul>
 *
 * @see org.nasdanika.architecture.cloud.azure.compute.ComputePackage#getVirtualMachine()
...
public interface VirtualMachine extends Resource {
	 ...
	 * The list contents are of type {@link org.nasdanika.architecture.cloud.azure.compute.Disk}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Disks</em>' containment reference list.
	 * @see org.nasdanika.architecture.cloud.azure.compute.ComputePackage#getVirtualMachine_Disks()
	 ...
	 * @see org.nasdanika.architecture.cloud.azure.compute.ComputePackage#getVirtualMachine_NetworkInterfaces()
	 * @model containment="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link org.nasdanika.architecture.cloud.azure.compute.VirtualMachine#getNetworkInterfaces <em>Network Interfaces</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.nasdanika.architecture.cloud.azure.compute.ComputePackage#getVirtualMachine_Image()
	...
	/**
	 * Sets the value of the '{@link org.nasdanika.architecture.cloud.azure.compute.VirtualMachine#getImage <em>Image</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.nasdanika.architecture.cloud.azure.compute.ComputePackage#getVirtualMachine_Size()
	 * @model annotation="urn:org.nasdanika opposite='virtualMachines'"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link org.nasdanika.architecture.cloud.azure.compute.VirtualMachine#getSize <em>Size</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
