 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.architecture.cloud.azure.networking.impl.ServiceImpl#getEndpoints <em>Endpoints</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ServiceImpl extends ResourceImpl implements Service {
	...
	public EList<ServiceEndpoint> getEndpoints() {
		return (EList<ServiceEndpoint>)eDynamicGet(NetworkingPackage.SERVICE__ENDPOINTS, NetworkingPackage.Literals.SERVICE__ENDPOINTS, true, true);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case NetworkingPackage.SERVICE__ENDPOINTS:
