 ...
 *
 */
public class HelmActionProviderAdapterFactory extends KubernetesActionProviderAdapterFactory {
	
	public HelmActionProviderAdapterFactory(Context context) {
		super(context);
...
//					}.asActionProvider()));
	...
	public HelmActionProviderAdapterFactory(Context context, Diagnostic diagnostic) {
		this(context);
