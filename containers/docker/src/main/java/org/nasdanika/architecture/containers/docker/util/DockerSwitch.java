	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DockerPackage.IMAGE: {
				...
				if (result == null) result = caseArchitectureElement(image);
				if (result == null) result = casePeriod(image);
				if (result == null) result = caseCore_ModelElement(image);
				...
				if (result == null) result = caseAdaptable(image);
				if (result == null) result = caseIMarked(image);
			...
			case DockerPackage.REGISTRY: {
				Registry registry = (Registry)theEObject;
				T result = caseRegistry(registry);
				if (result == null) result = caseArchitectureElement(registry);
				if (result == null) result = casePeriod(registry);
				if (result == null) result = caseCore_ModelElement(registry);
				if (result == null) result = caseNamedElement(registry);
				if (result == null) result = caseDocumented(registry);
				if (result == null) result = caseModelElement(registry);
				if (result == null) result = caseMarked(registry);
				if (result == null) result = caseAdaptable(registry);
				if (result == null) result = caseIMarked(registry);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
