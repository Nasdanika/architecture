...
public class DockerSiteGeneratorContributor implements SiteGeneratorContributor {
	...
	public List<AdapterFactory> createActionProviderAdapterFactories(
		...
		return Collections.singletonList(new DockerActionProviderAdapterFactory(context, instanceDiagnostic));
	}
