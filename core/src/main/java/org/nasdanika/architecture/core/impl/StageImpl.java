 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.architecture.core.impl.StageImpl#getImpacts <em>Impacts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StageImpl extends ArchitectureElementImpl implements Stage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.STAGE;
	}
	...
	public EList<Impact> getImpacts() {
		return (EList<Impact>)eDynamicGet(CorePackage.STAGE__IMPACTS, CorePackage.Literals.STAGE__IMPACTS, true, true);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CorePackage.STAGE__IMPACTS:
