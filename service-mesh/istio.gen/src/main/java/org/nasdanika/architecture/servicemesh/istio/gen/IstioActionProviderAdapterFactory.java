...
import org.nasdanika.architecture.containers.kubernetes.gen.KubernetesActionProviderAdapterFactory;
 ...
 *
 */
public class IstioActionProviderAdapterFactory extends KubernetesActionProviderAdapterFactory {
	
	public IstioActionProviderAdapterFactory(Context context) {
		super(context);
...
//					}.asActionProvider()));
	...
	public IstioActionProviderAdapterFactory(Context context, Diagnostic diagnostic) {
		this(context);
